...
combined_names <- tibble(
  ...
  var_names = c("PC1", "PC1 X Social housing",
                "Affordability X Social housing","PC2",
                "PC2 X Homeowner","Affordability X Homeowner",
                "Social housing",
                "Homeowner","Affordability","Private renting")
) %>% 
  mutate(
    var_names = fct_relevel(as.factor(var_names),
                            c("PC1 X Social housing",
                              "PC2 X Homeowner",
                              "PC1",
                              "PC2",
                              "Affordability X Social housing",
...
export_coefs <- c("Intercept" = "(Intercept)",
                  ...
                  "Affordability ratio X Homeowner" = "homeowner.affordability",
                  "Affordability ratio X Social housing" = "social_housing.affordability",
                  "PC2 X Homeowner" = "homeowner.pc2",
                  "PC1 X Social housing" = "social_housing.pc1",
                  "PC1" = "pc1",
                  "PC2" = "pc2",
                  "Homeowner" = "homeowner",
...
export_coefs2 <- c("Intercept" = "(Intercept)",
                   ...
                   "Affordability ratio (log) X Homeowner" = "affordability_log:homeowner",
                   "Affordability ratio (log) X Social housing" = "social_housing:affordability_log",
                   "Prices (log)" = "prices",
                   "Prices (log) X Homeowner" = "prices:homeowner",
                   "Prices (log) X Social housing" = "social_housing:prices",
                   "Homeowner" = "homeowner",
                   "Private renting" = "private_renting",
                   "Social housing" = "social_housing",
                   "Age" = "age",
